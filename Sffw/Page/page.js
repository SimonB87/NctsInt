            ...
            var Page = /** @class */ (function () {
                ...
                Page.prototype.focusControl = function (args) {
                    ...
                    if (_.isNumber(collectionIdx)) {
                        ...
                        if ($("div[data-name='" + args.name + "'] sffw-referencelookup").length >= 1 || $("div[data-name='" + args.name + "'] sffw-tariclookup").length >= 1) {
                            // referenceLookup or taricLookup
                            $("div[data-name='" + args.name + "']:eq(" + (collectionIdx - 1) + ") .editor-value .ui-autocomplete-input").focus();
                        }
                        else if ($("div[data-name='" + args.name + "'] sffw-iconstylecheckbox").length >= 1) {
                            // iconStyleCheckbox
                            $("div[data-name='" + args.name + "']:eq(" + (collectionIdx - 1) + ") .editor-value .sffw-icon-checkbox").focus();
                        }
                        else if ($("div[data-name='" + args.name + "']").length >= 1) {
                            // input editor
